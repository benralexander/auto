...
<div class="container">
    ...
    <div class="blog-header">
        ...
        <p class="lead blog-description">Comments of uncertain characterization</p>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-8 blog-main">
                ...
                <div class="blog-post">
                    ...
                    than uninfected people in tests of their visual processing</strong>. As well the attention spans oof infected people seemed to be lower. The effects they identified were not enormous but they were significant.</p>
                    ...
                    which would maybe explain a thing or two, such as the popularity of celebrities or reality TV.  The story is still unfolding but so far I find the implications pretty troubling.</p>

                    <p> If you want to see a journalistic summary of this story then check out <a href="http://news.sciencemag.org/biology/2014/10/algal-virus-found-humans-slows-brain-activity?utm_campaign=email-news-latest&utm_source=eloqua">this article</a></p>
            ...
            <div class="blog-post">
                ...
                <p>First let's consider the technical story.  I'll use a library that is distributed by a company called  <a href="https://www.mapbox.com/">mapbox</a>, and they certainly make the process easy.  You need only make
                ...
                include enough CSS to hold that DOM object in place. The sum total of  the code used in my example is reproduced below:</p>

                <pre>
    <code class="language-html" data-lang="html">
        <span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"map-container"</span><span class="nt">&gt;</span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nt">&lt;div</span> <span class="na">class=</span><span class="s">"map01"</span><span class="nt">&gt;</span>
    ...
    <code class="language-javascript" data-lang="javascript">
        ...
        #map01 {
            ...
            width: 100%;
                ...
                and some coming from the massive and fascinating <a href="http://www.openstreetmap.org">openstreetmap</a> project) so the data are also there for the taking.  So is all of
