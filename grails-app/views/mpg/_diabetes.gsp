    ...
    <div class="col-sm-6 col-md-4">
        <div class="thumbnail">
            ...
            <div class="caption">
                ...
                <p><a href="http://type2diabetesgen-qasrvr.elasticbeanstalk.com/" class="btn btn-primary" role="button">go to site</a> <a href="#" class="btn btn-default" role="button">Run in window</a></p>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-md-4">
