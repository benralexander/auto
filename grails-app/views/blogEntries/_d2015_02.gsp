...
<p class="blog-post-meta">February 7, 2015</p>
    ...
    <p>
        For years afterward no woman could legally be tested to determine whether or not she was a carrier of mutated BRCA1/2 unless her doctors used the test sold by Myriad Genetics.
        If you didn’t have the money, or if you thought the test should be conducted differently than you were out of luck.  Furthermore other scientists were prohibited from developing
        new tests, and Myriad aggressively brought suit against anyone else seeking to investigate the genes that the Myriad corporate officers thought belonged to them.
    </p>

    <p>
        Thus while our scientific understanding of DNA and molecular biology advanced rapidly over the next 15 years, Myriad was able to protect its profit making potential by wielding the
        23 patents it eventually accumulated protecting BRCA1 and 2.  Eventually, however, the Association for Molecular Pathology, a professional scientific group, challenged Myriad’s
        ...
        <a href="http://www.supremecourt.gov/opinions/12pdf/12-398_1b7d.pdf">invalid</a>.  Myriad tried again by pushing forward by advancing another series of patent claims, but on December 17
        the Federal Court of Appeals <a href="http://www.supremecourt.gov/opinions/12pdf/12-398_1b7d.pdf">rejected</a> Myriad’s attempt to advance another set of patent-based arguments.
        While the legal case might seem to be settled, Myriad’s influence continues to negatively impact women’s attempt to learn about their likelihood of getting cancer based on the BRCA genes.
    </p>

    <p>
        At issue now is the information about the specific mutations that underlie dysfunction in the two BRCA gene sequences. Each of the two genes is over 80,000 bases long, after all,
        and there are many ways in which such a sequence can go wrong. During those years when Myriad offered the sole diagnostic test in the area they accumulated a large database, mapping
        specific mutations to eventual clinical outcomes.  Despite the fact that other researchers could now explore this region of the human genome, nobody had developed a comprehensive
        database, and Myriad was entirely unwilling to share their information.  Their claim instead was that while you, the patient, were now entitled to use someone else’s kit, that you’d
        be a fool to do it, since Myriad had the best data and would, all of which was available only through the purchase of their diagnostic kit.
    </p>
