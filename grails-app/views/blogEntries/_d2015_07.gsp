...
<div class="blog-post">
    ...
    While obesity is clearly a driving cause of type 2 diabetes, the amount of fat on your body is not the only factor.
        ...
        fat, and overly processed foods) and
    ...
    <p>
        ...
        easing of suffering. No one can oppose efforts to comfort the sick, of course, but in a world of finite resources it would be nice to believe that resources
...
<div class="blog-post">
    ...
    <h2 class="blog-post-title"><a name="t2015jul28">Clash of curves</a></h2>

    <p class="blog-post-meta">July 28, 2015</p>
   ...
   <p>
      Exponential curves are unwieldy things, however, and the argument that technology can continually improve at an increasing rate
      seems difficult to justify.  Taken at the grandest scale of human development,  however, the argument of the technophiles
      seems so far to have been running according to plan.
     </p>


    <p>
       The first stone tools produced by our australopithecine ancestors were pretty primitive things.  These rock chips appear very
       similar to all the unintentionally broken rocks amongst which they have been unearthed in East Africa.   These 'Oldowan tools' were created around 2.6 million
       years ago, and they represent the first engineering efforts of the creatures that would go on to become Homo erectus.
    </p>
    <p>
       The next big technological development was the hand axe.  These rocks represented an important technological improvement:  they were distinctively shaped on one or both sides,
       and show evidence of being sharpened, and then later re-sharpened again, sometimes repeatedly.  Some of the stones are not native to the area in which they were found, and thus
       were likely moved considerable distances. Taken together these implements were called the Acheulean toolkit,  and they were a marked improvement over the Oldowan tools originally discovered
       in Olduvai Gorge.  Interestingly, however, these hand axes were not steppingstones leading to immediate improvements. For roughly 1 million years these stone hand axes
      ...
      <p>
        ...
        higher population densities, writing, and much else.
    </p>

    <p>
        The rate of change continues to increase, going ever faster. When I first started working with computers professionally in 1985 it was common to spend a few years
        learning an operating system and language combination, and when I switched to a new job I would expect to spend 12 months learning the ropes before I became productive.  Now I teach myself
        a couple of new languages each year, and a new person entering our group is expected to start contributing after only a few weeks on the job. And all this with the same  size
        brain case (about 1300 ccs) owned by the early Homo erectus who were banging out those repetitive Acheulean hand axes.
    </p>

    <p>
        If technological development has followed a roughly exponential curve, however,  where does this take us in the long run?  Can the same 1300 cubic centimeters continue
        to process new information ever more quickly, or will we reach a point where we can no longer increase the speed of innovation? The educational system, developed
        in post-Sputnik represents an attempt to optimize technological innovation,  is finely tuned to separate the most capable children and to press them into hypercompetitive
        universities where they exercise their capabilities to the limit.  Even the prodigies thus identified and trained cannot forever increase the speed of innovation,
        given the fundamental limitations of biological systems.
    </p>
    <p>
        Looking ahead I can imagine only two outcomes.  One possibility is that we better integrate digital technologies to aid us in our ability to think more efficiently.
        We can integrate search engines at a deep level as we think and work, and otherwise depend on computers to better organize the information we seek to process. I can't guess at the form
